...
#     # 3. Atomically increment the count at the correct index
...
#     print(f"Logged event for '{station_name}'. Incrementing index {current_index}. Current count: {current_count}")
